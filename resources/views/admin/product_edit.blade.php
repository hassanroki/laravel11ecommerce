                ...
                <div class="wg-box">
                        ...
                        <div class="upload-image flex-grow">
                            @if ($product->image)
                                <div class="item" id="imgpreview">
                                    <img src="{{ asset($product->image) }}" class="effect8" alt="{{ $product->name }}">
                                </div>
                            @endif
                            ...
                            @if ($product->images)
                                @foreach ($product->images as $img)
                                    <div class="item gitems">
                                        <img src="{{ asset($img) }}" class="effect8" alt="{{ $product->name }}">
                                    </div>
                                @endforeach
                            @endif
                    ...
                    <div class="cols gap22">
                        ...
                        <fieldset class="name">
                            ...
                            <div class="select mb-10">
                                <select class="" name="features">
                                    <option value="0" {{ $product->features == '0' ? 'selected' : '' }}>No</option>
                                    <option value="1" {{ $product->features == '1' ? 'selected' : '' }}>Yes</option>
                                </select>
                            </div>
                        </fieldset>
                        @error('features')
    ...
    <script>
        $(function() {
            ...
            $("#gFile").on("change", function(e) {
                ...
                $("#galUpload").siblings('.gitems').remove(); // Remove old previews
