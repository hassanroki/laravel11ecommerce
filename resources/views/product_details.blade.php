                            ...
                            <div class="swiper-container">
                                <div class="swiper-wrapper">
                                    ...
                                    @foreach (explode(',', $product->images) as $gimg)
                                        @php
                                            $gimg = trim($gimg, '[]"'); // Remove extra quotes or brackets
                                        @endphp
                                        <div class="swiper-slide product-single__image-item">
                            ...
                            <div class="swiper-container">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide product-single__image-item"><img loading="lazy" class="h-auto"
                                            src="{{ asset($product->image) }}" width="104" height="104"
                                            alt="" /></div>
                                    ...
                                    @foreach (explode(',', $product->images) as $gimg)
                                        ...
                                        <div class="swiper-slide product-single__image-item"><img loading="lazy"
                                                class="h-auto" src="{{ asset($gimg) }}" width="104" height="104"
                                                alt="" /></div>
                                    @endforeach
                    ...
                    <div class="product-single__addtolinks">
                        @if (Cart::instance('wishlist')->content()->where('id', $product->id)->count() > 0)
                            <form
                                ...
                                method="POST" id="removeItem">
                                @csrf
                                @method('DELETE')
                                <a href="javascript:void(0)" onclick="document.getElementById('removeItem').submit();"
                                    class="menu-link menu-link_us-s add-to-wishlist" style="color: orange;"><svg
                        ...
                        @else
                            <form action="{{ route('wishlist.add') }}" method="POST" id="wishListForm">
                                ...
                                <a href="javascript:void(0)" class="menu-link menu-link_us-s add-to-wishlist"
                                    onclick="document.getElementById('wishListForm').submit();"><svg width="16"
                        ...
                        @foreach ($products as $rproduct)
                            <div class="swiper-slide product-card">
                                <div class="pc__img-wrapper">
                                    <a href="{{ route('product.shop.view', ['product_slug' => $rproduct->slug]) }}">
                                        <img loading="lazy" src="{{ asset($rproduct->image) }}" width="330"
                                    ...
                                    @if (Cart::instance('cart')->content()->where('id', $rproduct->id)->count() > 0)
                                        <a href="{{ route('cart.index') }}"
                                            class="pc__atc btn anim_appear-bottom btn position-absolute border-0 text-uppercase fw-medium js-add-cart btn-warning mb-3">Go
                                            to Cart</a>
                                    @else
                                        <form name="addtocart-form" method="post" action="{{ route('cart.add') }}">
                                            @csrf
