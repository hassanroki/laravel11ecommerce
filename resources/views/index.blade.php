      ...
      "loop": true
        ...
        <div class="container mw-1620 bg-white border-radius-10">
                                    ...
                                    @foreach ($sproducts as $sproduct)
                                        <div class="swiper-slide product-card product-card_style3">
                                            <div class="pc__img-wrapper">
                                                <a href="{{ route('product.shop.view', ['product_slug' => $sproduct->slug]) }}">
                                                    <img loading="lazy"
                                                        src="{{ asset($sproduct->image) }}"
                                            ...
                                            <div class="pc__info position-relative">
                                                <h6 class="pc__title"><a href="{{ route('product.shop.view', ['product_slug' => $sproduct->slug]) }}">{{ $sproduct->name }}</a></h6>
            ...
            <section class="products-grid container">
                ...
                <div class="row">
                    @foreach ($featuresProducts as $featureProduct)
                    <div class="col-6 col-md-4 col-lg-3">
                        <div class="product-card product-card_style3 mb-3 mb-md-4 mb-xxl-5">
                            <div class="pc__img-wrapper">
                                <a href="{{ route('product.shop.view', ['product_slug' => $featureProduct->slug]) }}">
                                    <img loading="lazy"
                                        src="{{ asset($featureProduct->image) }}"
                                        width="330" height="400" alt="{{ $featureProduct->name }}" class="pc__img">
                                </a>
                            </div>

                            <div class="pc__info position-relative">
                                <h6 class="pc__title"><a href="{{ route('product.shop.view', ['product_slug' => $featureProduct->slug]) }}">{{ $featureProduct->name }}</a></h6>
