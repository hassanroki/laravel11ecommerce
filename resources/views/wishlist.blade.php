                                    ...
                                    <tr>
                                        <td>
                                            <div class="shopping-cart__product-item">
                                                <img loading="lazy" src="{{ asset($item->model->image) }}" width="120"
                                                    height="120" alt="{{ asset($item->name) }}" />
                                            </div>
                                        </td>
                                        <td>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6">
                                                    <form
                                                        ...
                                                        method="POST" id="removeItem{{ $item->id }}">
                                                        @csrf
                                                        @method('DELETE')
                                                        <a href="javascript:void(0)" class="remove-cart"
                                                            onclick="document.getElementById('removeItem{{ $item->id }}').submit();">
