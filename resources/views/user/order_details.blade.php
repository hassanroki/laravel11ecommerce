                            ...
                            <table class="table table-striped table-bordered">
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ date('d-m-Y h:i A', strtotime($order->delivered_date)) }}</td>
                                        <th>Canceled Date</th>
                                        <td>{{ date('d-m-Y h:i A', strtotime($order->canceled_date)) }}</td>
                                    </tr>
                                    <tr>
                                        <th>Order Status</th>
                                        <td colspan="5">
                                    ...
                                    @foreach ($orderItems as $item)
                                        <tr>
                                            ...
                                            <td class="pname">
                                                ...
                                                <div class="name">
                                                    <a href="{{ route('product.shop.view', ['product_slug' => $item->product->slug]) }}"
